              ...
              <div className="text-center py-8">
                ...
                <div className="mt-3 flex flex-wrap justify-center gap-2">
                  <button
                    ...
                    className="text-xs bg-electric text-white px-2.5 py-1 rounded-full hover:bg-[#6D28D9] transition-colors flex items-center gap-1 disabled:opacity-50"
                  >
                    {analyze.isPending
            ...
            {msg.proposals.map((rule, i) => (
              <div
                ...
                className={cn(
                  ...
                  approved.has(i) ? "border-electric/40 bg-lavender/30" : "border-border bg-surface opacity-60"
                )}
              >
                <div className={cn(
                  "shrink-0 w-3.5 h-3.5 rounded border-2 flex items-center justify-center transition-colors",
                  approved.has(i) ? "bg-electric border-electric" : "bg-white border-slate/40"
                )}>
                  {approved.has(i) && (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-xs text-slate ml-2 font-data">{rule.affected_count} rows</span>
                </div>
              </div>
            ))}
          </div>
          <div className="flex items-center gap-2 px-3 py-2.5 border-t border-electric/20">
            <Button
  ...
  if (msg.proposals && dismissed) {
    return (
      <div className="flex flex-col gap-1 max-w-lg">
        ...
        <span className="text-xs text-slate pl-1">Rules applied ✓</span>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-2 px-3 py-2 flex-wrap">
            {applied ? (
              <div className="flex items-center gap-2">
                ...
                {savedGlobal && (
                  <span className="text-xs text-electric font-semibold bg-lavender px-1.5 py-0.5 rounded flex items-center gap-1">
              ...
              <>
                ...
                <Button
                  ...
                  disabled={applying}
                  variant="outline"
                  className="h-7 text-xs font-semibold gap-1 text-electric border-electric/30 hover:bg-lavender"
                >
